    ...
    return {
        ...
        'profitChart': {
            ...
            data: {
                labels: ['2022', '2023', '2024'],
                datasets: [
                    { label: 'EBIT', data: [53.8, 69.2, 83.1], backgroundColor: pattern.draw('diagonal', '#8b5cf6'), borderColor: '#8b5cf6', borderRadius: 0 },
                    { label: 'Utile', data: [32.0, 40.4, 52.4], backgroundColor: pattern.draw('diagonal', '#52525b'), borderColor: '#52525b', borderRadius: 0 }
                ]
            },
            options: {
                responsive: true,
        ...
        'cashFlowWaterfallChart': {
            ...
            data: {
                ...
                datasets: [{
                    data: [52.4, 22.9, 0.8, -30.9, -4.5, -46.3, -5.7],
                    backgroundColor: [
        ...
        'debtStructureChart': {
            ...
            data: {
                labels: ['2022', '2023', '2024'],
                datasets: [
                    { label: 'Breve', data: [65.4, 110.3, 125.7], backgroundColor: pattern.draw('diagonal', '#8b5cf6'), borderColor: '#8b5cf6', borderRadius: 0 },
                    { label: 'Lungo', data: [90.2, 70.6, 50.7], backgroundColor: pattern.draw('diagonal', '#52525b'), borderColor: '#52525b', borderRadius: 0 }
                ]
            },
            options: {
                responsive: true,
        ...
        'dupontMarginChart': {
            ...
            options: {
                ...
                animation: animationConfig,
                plugins: { legend: { display: false } },
                scales: { y: { beginAtZero: true, max: 15, ticks: { callback: v => v + '%' } } }
            }
        },
        ...
        'breakEvenChart': {
            type: 'line',
            data: {
                labels: ['0', '150', '300', '400', '536'],
                datasets: [
                    {
                        label: 'Ricavi',
                        data: [0, 150, 300, 400, 536],
                        borderColor: '#8b5cf6',
                        borderWidth: 3,
                        fill: false,
                        tension: 0,
                    ...
                    {
                        label: 'Costi Totali',
                        data: [80.0, 184.2, 288.5, 358.0, 452.5],
                        borderColor: '#3f3f46',
                        borderWidth: 3,
                        fill: false,
                        tension: 0,
        ...
        'attivoDonutChart': {
            ...
            data: {
                ...
                datasets: [{
                    data: [5.8, 220.7, 0.0, 78.8, 3.4, 3.8, 44.7],
        ...
        'passivoDonutChart': {
            type: 'doughnut',
            data: {
                labels: ['Debiti Breve', 'Debiti Lungo', 'Utile Esercizio', 'Capitale', 'Fondi Rischi', 'TFR', 'Altre Riserve', 'Riserva Legale', 'Ratei'],
                datasets: [{
                    data: [125.7, 50.7, 52.4, 10, 19.2, 1.6, 91.2, 2, 4.4],
        ...
        'costiDonutChart': {
            ...
            data: {
                ...
                datasets: [{
                    data: [341.8, 53.5, 22.9, 3.6, 21.7, 9.1],
